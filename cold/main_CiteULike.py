...
def main():
    ...
    val_eval.init_tf(u_pref, v_pref, None, item_content, eval_batch_size, cold_item=True)
    warm_test_eval.init_tf(u_pref, v_pref, None, item_content, eval_batch_size, cold_item=True)
...
def load_data(data_name):
    ...
    max_user_id = np.max(dat['user_list'])
